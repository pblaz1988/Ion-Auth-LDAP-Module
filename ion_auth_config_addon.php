...
$config['ldap_bindUser'] 			= '';		// bind user (query user) full DN
$config['ldap_pwd'] 				= '';		// bind user password 
$config['ldap_baseDN'] 				= '';		// base DN
$config['ldap_baseDNForBind'] 		= '';		// base DN for bind
$config['ldap_ldapZahtevanaGrupa']	= '';		// user must be member of this group (full DN string)
$config['ldap_server'] 				= '';		// ldap server ip or fqdn
